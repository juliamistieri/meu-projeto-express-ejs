...
const produtos = [
  {id: 1,
     nome:"Jaqueta Nike Sportswear Tech Fleece Windrunner",
      preco:"589,99",
       descricao:"Combinando 2 de nossos looks mais icônicos, este moletom com capuz de zíper completo foi inspirado em nossa jaqueta atemporal Windrunner, bem como em nossa jaqueta Tech Fleece. Ele é feito para ter um caimento solto nos ombros, peito e corpo para um ajuste esportivo que você pode usar em camadas. Os bolsos com fita exclusiva proporcionam um armazenamento seguro e fácil acesso.",
  ...
  {id: 3,
     nome:"Tênis Nike Air Force 1 07 Unissex",
   preco:"799,90",
